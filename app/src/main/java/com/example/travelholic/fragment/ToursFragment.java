...
public class ToursFragment extends Fragment {
    ...
    private void loadAll() {
        String url = "http://10.0.2.2/travelholic-app/server/index.php?controller=tour&action=load_all";
    ...
    private void search(String query) {
        RequestBody body = new FormBody.Builder()
                .add("keyword", query)
                .build();
        String url = "http://10.0.2.2/travelholic-app/server/index.php?controller=tour&action=search";
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .build();
