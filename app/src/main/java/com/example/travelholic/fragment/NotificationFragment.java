...
public class NotificationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        String url = "http://10.0.2.2/travelholic-app/server/index.php?controller=notification&action=load_all&username=" + session.getUsername();
                ...
                try {
                    ...
                    getActivity().runOnUiThread(() -> {
                        ...
                        adapter.setOnItemClickListener(position -> {
                            String urlAccept = "http://10.0.2.2/travelholic-app/server/index.php?controller=tour&action=accept&username="
