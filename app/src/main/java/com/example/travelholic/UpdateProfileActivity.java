...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(v -> {
            ...
            if (body != null) {
                String url = "http://10.0.2.2/travelholic-app/server/index.php?controller=user&action=update";
    ...
    private void init() {
        ...
        OkHttpClient client = new OkHttpClient();
        String url = "http://10.0.2.2/travelholic-app/server/index.php?controller=user&action=get_detail&username=" + session.getUsername();
        Request request = new Request.Builder()
                .url(url)
                .build();
