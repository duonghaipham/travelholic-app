            ...
            if (btnSubmit.getText().toString().equals("Send")) {
                if (isValidEmail(txtInput.getText())) {
                    RequestBody body = new FormBody.Builder()
                            ...
                            .build();
                    String url = "http://10.0.2.2/travelholic-app/server/index.php?controller=user&action=reset";
                ...
                if (!txtInput.getText().toString().isEmpty()) {
                    RequestBody body = new FormBody.Builder()
                            ...
                            .build();
                    String url = "http://10.0.2.2/travelholic-app/server/index.php?controller=User&action=verify";
                    Request request = new Request.Builder()
                            .url(url)
                            .build();
                    client.newCall(request).enqueue(new Callback() {
