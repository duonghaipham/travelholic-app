...
import com.example.travelholic.adapter.MemberAddingRecyclerViewAdapter;
...
public class CreateTourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            if (mode.equals("create"))
                url = "http://10.0.2.2/travelholic-app/server/index.php?controller=tour&action=create";
            else
                url = "http://10.0.2.2/travelholic-app/server/index.php?controller=tour&action=update";
    ...
    private void initAdapter() {
        ...
        OkHttpClient client = new OkHttpClient();
        String url = "http://10.0.2.2/travelholic-app/server/index.php?controller=user&action=get_all_usernames";
        Request request = new Request.Builder()
                .url(url)
                .build();
        client.newCall(request).enqueue(new Callback() {
